...
if ( is_user_logged_in() ) {
    //echo 'Usuario Logado';
		   ...
		   // echo 'User email: ' . $current_user->user_email . '<br />';
			...
			echo get_site_url();
			echo '/minha-conta/orders/" style="margin:0px 20px;"> <i class="fa fa-user"></i> Minha Conta </a>';
	...
	echo'<a class="login_button inline" href="';
	echo get_site_url();
	echo '/minha-conta/"><i class="fa fa-user"></i>Entrar</a>';
	
	//echo '<a class="login_button inline"  href="';
	//echo get_site_url();
	//echo '/minha-conta/"><i class="fa fa-pencil"></i>Cadastrar</a>';
}	
