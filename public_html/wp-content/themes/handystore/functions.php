...
/** Contents:
		...
		- Adding features.
**/
wc_get_template_part('alex_functions_2020');
...
if ( function_exists( 'add_image_size' ) ) {
	...
	add_image_size( 'pt-recent-posts-thumb', 263, 263, true);
	add_image_size( 'pt-sidebar-thumbs', 80, 80, true);
	add_image_size( 'pt-vendor-product-thumbs', 120, 120, true);
	add_image_size( 'pt-gallery-s', 265, 265, true);
	add_image_size( 'pt-gallery-m', 360, 360, true);
	add_image_size( 'pt-gallery-l', 555, 555, true);
}
